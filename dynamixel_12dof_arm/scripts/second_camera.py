...
def callback(data):
    ...
    if data.data == 1.0:
        ...
        if len(color_state) == 54:
            ...
            #                                 |
            #              |        |         |        |        |
            scan1 =[2, 0, 3, 5, 1, 1, 0, 5, 5, 2, 4, 2, 0, 2, 4, 4, 2, 4]#オレンジ 1、緑 2
            scan2 = [5, 4, 4, 2, 4, 0, 0, 5, 4, 1, 2, 1, 3, 5, 1, 3, 4, 3]#青、4 黄色 5
            scan3 =[1, 3, 1, 2, 0, 5, 5, 1, 0, 2, 1, 0, 3, 3, 0, 3, 3, 5]#白、0 赤 3
            scan1.extend(scan2)
            scan1.extend(scan3)
            print(scan1)
