...
def callback(data):
    ...
    if data.data == 1.0:
        ...
        color_state.extend(pred)
        #print("this is whole color list:",color_state)
        #publish
        ...
        if len(color_state) == 54:
            ...
            #                                 |
            #              |        |         |        |        |
            scan1 =[1, 4, 2, 1, 1, 4, 5, 1, 5, 0, 5, 5, 3, 2, 3, 3, 4, 2]#オレンジ 1、緑 2
            scan2 =[2, 2, 3, 5, 4, 1, 4, 0, 0, 2, 0, 4, 5, 5, 1, 4, 5, 3]#青、4 黄色 5
            scan3 =[5, 4, 1, 0, 0, 3, 1, 3, 4, 0, 2, 3, 2, 3, 2, 1, 0, 0]#白、0 赤 3
            scan1.extend(scan2)
            scan1.extend(scan3)
            print(scan1)
